...
def create_cinematic_text_clip(text, font_size, duration, start_time, position='lower_third', panel_bg=True):
    ...
    """
    # 1. Wrap text and get its dimensions using a dummy image
    ...
    # 2. Create the final composite image (panel + text) using PIL
    ...
    # Use your stylized panel function
...
# ✅✅✅ --- NEW, SIMPLIFIED, WHISPER-BASED TIMING LOGIC --- ✅✅✅
...
# Load the perfect timings generated by Whisper. No fallback needed.
enhanced_timing = load_enhanced_timing()
if not enhanced_timing or not enhanced_timing.get('sections'):
    raise ValueError("FATAL: Whisper-generated timing data (audio_timing.json) not found or is invalid.")

scene_starts, paragraph_durations = [], []
print("\n⏱️ Using PRE-CALCULATED Whisper timings from audio_timing.json...")
...
if final_drift > 0.5:
    print(f"   ⚠️ NOTE: Sync drift represents trailing silence after last word, which is normal.")
else:
    print(f"   ✅ Excellent sync.")

# ✅✅✅ --- END OF NEW TIMING LOGIC --- ✅✅✅
